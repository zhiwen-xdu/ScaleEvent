...
from vfm2event.dataset import DDD17_SEG_EOMT_TRAIN,DDD17_SEG_EOMT_TEST
...
def transfer(experiment_id="SEG01-DDD17",epoch_num=10,batch_size=16):
    ...
    weight = "/home/zhiyu/projects/DINOv3/vfm2event/output/DINO20/checkpoints/ViTL16_Event_Encoder_EP05.pth"
