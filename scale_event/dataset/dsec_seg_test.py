...
class DSEC_SEG_TEST(torch.utils.data.Dataset):
    ...
    def _get_data(self, seq_id, frame_id):
        ...
        seg_mask = prepare_semantic_label(mask_path,W=self.W,H=self.H)
...
if __name__ == "__main__":
    dataset = DSEC_SEG_TEST(split="train")
