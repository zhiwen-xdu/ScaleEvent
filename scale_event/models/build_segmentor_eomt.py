...
class EoMT_ViTL(nn.Module):
    def __init__(
        ...
        self.backbone_weight = ".../pretrained/dinov3_vitl16_pretrain_lvd1689m-8aa4cbdd.pth"   # Needs modification
        self.eomt_weight = ".../pretrained/dinov3_eomt_vitl16_ade20k.ckpt"   # Needs modification
...
class EoMT_ViTB(nn.Module):
    def __init__(
        ...
        self.backbone_type = backbone_type
        self.backbone_weight = ".../pretrained/dinov3_vitb16_pretrain_lvd1689m-73cec8be.pth"  # Needs modification
        self.eomt_weight = ".../pretrained/dinov3_eomt_vitl16_ade20k.ckpt" # Needs modification
...
class EoMT_ViTS(nn.Module):
    def __init__(
        ...
        self.backbone_type = backbone_type
        self.backbone_weight = ".../pretrained/dinov3_vits16_pretrain_lvd1689m-08c60483.pth" # Needs modification
        self.eomt_weight = ".../pretrained/dinov3_eomt_vitl16_ade20k.ckpt"  # dinov3_eomt_vitl16_ade20k.ckpt; ade20k_semantic_eomt_large_512_dinov3.bin
