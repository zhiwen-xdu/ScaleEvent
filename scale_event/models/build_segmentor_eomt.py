...
class EoMT_ViTL(nn.Module):
    def __init__(
        ...
        self.backbone_weight = "/data1/zwchen/project/DINOv3/pretrained/dinov3_vitl16_pretrain_lvd1689m-8aa4cbdd.pth"  # dinov3_vitb16_pretrain_lvd1689m-73cec8be.pth
        self.eomt_weight = "/data1/zwchen/project/DINOv3/pretrained/dinov3_eomt_vitl16_ade20k.ckpt"  # dinov3_eomt_vitl16_ade20k.ckpt; ade20k_semantic_eomt_large_512_dinov3.bin
...
# net = EoMT_ViTL(num_classes=11,h=30,w=40)
#
# net.to(device)
# x = torch.randn(1,3,480,640).to(device)
#
# macs, params = profile(net.to(device), inputs=(x,None))
